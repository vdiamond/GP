...
namespace QUT.Gplex.Automaton
{
	...
	internal class TaskState : IDisposable
	{
        ...
        TextReader FrameReader()
        {
            ...
            {
                string gplexxFrame = QUT.Gputil.FrameManager.Get("GplexxFrame");
        ...
        void CopyBufferCode()
        {
            ...
            GplexBuffers = QUT.Gputil.FrameManager.Get("GplexBuffers");

            writer.WriteLine(QUT.Gputil.FrameManager.Get("ResourceHeader"));
